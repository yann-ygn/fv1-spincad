...
public class SpinCADMenuGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MenuElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.holycityaudio.spincadmenu.SpinCADMenu.Menu");
	...
	public class ElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.holycityaudio.spincadmenu.SpinCADMenu.Element");
	...
	public class MENU_HEADERElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.holycityaudio.spincadmenu.SpinCADMenu.MENU_HEADER");
	...
	public class MENU_ITEMElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.holycityaudio.spincadmenu.SpinCADMenu.MENU_ITEM");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TEST_ITEMElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.holycityaudio.spincadmenu.SpinCADMenu.TEST_ITEM");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final MENU_HEADERElements pMENU_HEADER;
	private final MENU_ITEMElements pMENU_ITEM;
	private final TEST_ITEMElements pTEST_ITEM;
	...
	public SpinCADMenuGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pMENU_HEADER = new MENU_HEADERElements();
		this.pMENU_ITEM = new MENU_ITEMElements();
		this.pTEST_ITEM = new TEST_ITEMElements();
	}
