 ...
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SPINMEMImpl#getScale <em>Scale</em>}</li>
...
public class SPINMEMImpl extends MinimalEObjectImpl.Container implements SPINMEM
{
  ...
  public void setScale(String newScale)
  {
    ...
    scale = newScale;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SPINMEM__SCALE, oldScale, scale));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SpinCADPackage.SPINMEM__VALUE:
        return getValue();
      case SpinCADPackage.SPINMEM__SCALE:
        return getScale();
