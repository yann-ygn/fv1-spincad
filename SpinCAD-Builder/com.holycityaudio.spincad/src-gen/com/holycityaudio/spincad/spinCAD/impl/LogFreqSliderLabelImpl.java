...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Log Freq Slider Label</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.LogFreqSliderLabelImpl#getControlName <em>Control Name</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.LogFreqSliderLabelImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.LogFreqSliderLabelImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.LogFreqSliderLabelImpl#getInitVal <em>Init Val</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.LogFreqSliderLabelImpl#getMultiplier <em>Multiplier</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.LogFreqSliderLabelImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.LogFreqSliderLabelImpl#getOption <em>Option</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogFreqSliderLabelImpl extends ControlImpl implements LogFreqSliderLabel
{
  /**
   ...
   * @generated
   */
  protected LogFreqSliderLabelImpl()
  {
    super();
  }
  ...
  {
    return SpinCADPackage.Literals.LOG_FREQ_SLIDER_LABEL;
  }
  ...
  public void setControlName(String newControlName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.LOG_FREQ_SLIDER_LABEL__CONTROL_NAME, oldControlName, controlName));
  }
  ...
  public void setMinVal(String newMinVal)
  {
    ...
    minVal = newMinVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.LOG_FREQ_SLIDER_LABEL__MIN_VAL, oldMinVal, minVal));
  }
  ...
  public void setMaxVal(String newMaxVal)
  {
    ...
    maxVal = newMaxVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.LOG_FREQ_SLIDER_LABEL__MAX_VAL, oldMaxVal, maxVal));
  }
  ...
  public void setInitVal(String newInitVal)
  {
    ...
    initVal = newInitVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.LOG_FREQ_SLIDER_LABEL__INIT_VAL, oldInitVal, initVal));
  }
  ...
  public void setMultiplier(String newMultiplier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.LOG_FREQ_SLIDER_LABEL__MULTIPLIER, oldMultiplier, multiplier));
  }
  ...
  public void setPrecision(int newPrecision)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.LOG_FREQ_SLIDER_LABEL__PRECISION, oldPrecision, precision));
  }
  ...
  public void setOption(String newOption)
  {
    ...
    option = newOption;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.LOG_FREQ_SLIDER_LABEL__OPTION, oldOption, option));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpinCADPackage.LOG_FREQ_SLIDER_LABEL__CONTROL_NAME:
        return getControlName();
      case SpinCADPackage.LOG_FREQ_SLIDER_LABEL__MIN_VAL:
        return getMinVal();
      case SpinCADPackage.LOG_FREQ_SLIDER_LABEL__MAX_VAL:
        return getMaxVal();
      case SpinCADPackage.LOG_FREQ_SLIDER_LABEL__INIT_VAL:
        return getInitVal();
      case SpinCADPackage.LOG_FREQ_SLIDER_LABEL__MULTIPLIER:
        return getMultiplier();
      case SpinCADPackage.LOG_FREQ_SLIDER_LABEL__PRECISION:
        return getPrecision();
      case SpinCADPackage.LOG_FREQ_SLIDER_LABEL__OPTION:
        return getOption();
    }
