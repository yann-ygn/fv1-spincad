...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Slider Label Spinner</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SliderLabelSpinnerImpl#getControlName <em>Control Name</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SliderLabelSpinnerImpl#getMinVal <em>Min Val</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SliderLabelSpinnerImpl#getMaxVal <em>Max Val</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SliderLabelSpinnerImpl#getInitVal <em>Init Val</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SliderLabelSpinnerImpl#getMultiplier <em>Multiplier</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SliderLabelSpinnerImpl#getPrecision <em>Precision</em>}</li>
 *   <li>{@link com.holycityaudio.spincad.spinCAD.impl.SliderLabelSpinnerImpl#getOption <em>Option</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SliderLabelSpinnerImpl extends ControlImpl implements SliderLabelSpinner
{
  /**
   ...
   * @generated
   */
  protected SliderLabelSpinnerImpl()
  {
    super();
  }
  ...
  {
    return SpinCADPackage.Literals.SLIDER_LABEL_SPINNER;
  }
  ...
  public void setControlName(String newControlName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SLIDER_LABEL_SPINNER__CONTROL_NAME, oldControlName, controlName));
  }
  ...
  public void setMinVal(String newMinVal)
  {
    ...
    minVal = newMinVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SLIDER_LABEL_SPINNER__MIN_VAL, oldMinVal, minVal));
  }
  ...
  public void setMaxVal(String newMaxVal)
  {
    ...
    maxVal = newMaxVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SLIDER_LABEL_SPINNER__MAX_VAL, oldMaxVal, maxVal));
  }
  ...
  public void setInitVal(String newInitVal)
  {
    ...
    initVal = newInitVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SLIDER_LABEL_SPINNER__INIT_VAL, oldInitVal, initVal));
  }
  ...
  public void setMultiplier(String newMultiplier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SLIDER_LABEL_SPINNER__MULTIPLIER, oldMultiplier, multiplier));
  }
  ...
  public void setPrecision(int newPrecision)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SLIDER_LABEL_SPINNER__PRECISION, oldPrecision, precision));
  }
  ...
  public void setOption(String newOption)
  {
    ...
    option = newOption;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpinCADPackage.SLIDER_LABEL_SPINNER__OPTION, oldOption, option));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpinCADPackage.SLIDER_LABEL_SPINNER__CONTROL_NAME:
        return getControlName();
      case SpinCADPackage.SLIDER_LABEL_SPINNER__MIN_VAL:
        return getMinVal();
      case SpinCADPackage.SLIDER_LABEL_SPINNER__MAX_VAL:
        return getMaxVal();
      case SpinCADPackage.SLIDER_LABEL_SPINNER__INIT_VAL:
        return getInitVal();
      case SpinCADPackage.SLIDER_LABEL_SPINNER__MULTIPLIER:
        return getMultiplier();
      case SpinCADPackage.SLIDER_LABEL_SPINNER__PRECISION:
        return getPrecision();
      case SpinCADPackage.SLIDER_LABEL_SPINNER__OPTION:
        return getOption();
    }
