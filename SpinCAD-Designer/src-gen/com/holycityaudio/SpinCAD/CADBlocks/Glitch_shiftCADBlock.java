 ...
 */ 
		...
		import com.holycityaudio.SpinCAD.SpinFXBlock;
 		import com.holycityaudio.SpinCAD.ControlPanel.Glitch_shiftControlPanel;
		
	    @SuppressWarnings("unused")
	    public class Glitch_shiftCADBlock extends SpinCADBlock {
			...
			public void editBlock(){ 
				if(cp == null) {
					if(hasControlPanel == true) {
						cp = new Glitch_shiftControlPanel(this);
					}
				}
			}
			...
			sfxb.chorusScaleOffset(RMP0, NA, 0);
			sfxb.FXchorusReadDelay(RMP0, NA |COMPC, "temp", 0);
			} else {
			...
			sfxb.chorusScaleOffset(RMP1, NA, 0);
			sfxb.FXchorusReadDelay(RMP1, NA|COMPC, "temp", 0);
			}
