 ...
 * ga_demo_echo_repeatControlPanel.java
...
public ga_demo_echo_repeatControlPanel(ga_demo_echo_repeatCADBlock genericCADBlock) {
		...
		class ga_demo_echo_repeatListener implements ChangeListener { 
		public void stateChanged(ChangeEvent ce) {
			}
		}

		// add item state changed listener for Checkbox
		class ga_demo_echo_repeatItemListener implements java.awt.event.ItemListener { 
