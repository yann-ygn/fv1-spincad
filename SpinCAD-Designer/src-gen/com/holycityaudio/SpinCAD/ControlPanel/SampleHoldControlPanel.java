...
public SampleHoldControlPanel(SampleHoldCADBlock genericCADBlock) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				lfoSelComboBox.addActionListener(new SampleHoldActionListener());
		...
		class SampleHoldItemListener implements java.awt.event.ItemListener { 
