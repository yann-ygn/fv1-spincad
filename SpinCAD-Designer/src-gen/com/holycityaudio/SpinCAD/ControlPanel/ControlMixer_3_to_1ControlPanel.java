 ...
 * ControlMixer_3_to_1ControlPanel.java
...
public ControlMixer_3_to_1ControlPanel(ControlMixer_3_to_1CADBlock genericCADBlock) {
		...
		public void stateChanged(ChangeEvent ce) {
			...
			gCB.setgain3((double) (gain3Slider.getValue()/1000.0));
				updategain3Label();
			}
			}
		}
		...
		class ControlMixer_3_to_1ItemListener implements java.awt.event.ItemListener { 
		...
		class ControlMixer_3_to_1ActionListener implements java.awt.event.ActionListener { 
			@Override
