...
public AbsaControlPanel(AbsaCADBlock genericCADBlock) {
		...
		class AbsaItemListener implements java.awt.event.ItemListener { 
		...
		class AbsaActionListener implements java.awt.event.ActionListener { 
			@Override
