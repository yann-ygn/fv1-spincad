...
public pitchoffsetControlPanel(pitchoffsetCADBlock genericCADBlock) {
		...
		class pitchoffsetItemListener implements java.awt.event.ItemListener { 
		...
		class pitchoffsetActionListener implements java.awt.event.ActionListener { 
			@Override
