...
public crossfadeControlPanel(crossfadeCADBlock genericCADBlock) {
		...
		class crossfadeItemListener implements java.awt.event.ItemListener { 
		...
		class crossfadeActionListener implements java.awt.event.ActionListener { 
			@Override
