...
public LFO_ValueControlPanel(LFO_ValueCADBlock genericCADBlock) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				frame = new JFrame();
				frame.setTitle("LFO Value");
				frame.setLayout(new BoxLayout(frame.getContentPane(), BoxLayout.Y_AXIS));

				lfoSelComboBox = new JComboBox <String> ();
				lfoSelComboBox.addItem("Sin 0");
				lfoSelComboBox.addItem("Cos 0");
			lfoSelComboBox.addItem("Sin 1");
			lfoSelComboBox.addItem("Cos 1");
			...
			lfoSelComboBox.addItem("Ramp 1");
				...
				lfoSelComboBox.addActionListener(new LFO_ValueActionListener());
		...
		class LFO_ValueItemListener implements java.awt.event.ItemListener { 
