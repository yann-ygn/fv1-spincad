...
public class Mixer_4_to_1ControlPanel extends spinCADControlPanel {
	private JFrame frame;
	private Mixer_4_to_1CADBlock gCB;
...
public Mixer_4_to_1ControlPanel(Mixer_4_to_1CADBlock genericCADBlock) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			//
					...
					// ---------------------------------------------						
					// dB level slider goes in steps of 1 dB
						gain4Slider = new JSlider(JSlider.HORIZONTAL, (int)(-24),(int) (0), (int) (20 * Math.log10(gCB.getgain4())));
		...
		class Mixer_4_to_1ItemListener implements java.awt.event.ItemListener { 
		...
		class Mixer_4_to_1ActionListener implements java.awt.event.ActionListener { 
			@Override
